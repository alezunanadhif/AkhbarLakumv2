...
import com.nadhif.akhbar_lakum_v2.databinding.FragmentAntaraHukumNewsBinding
import com.nadhif.akhbar_lakum_v2.ui.NewsViewModel
import com.nadhif.akhbar_lakum_v2.utils.NewsViewModelFactory

class AntaraHukumNewsFragment : Fragment() {
	private lateinit var binding: FragmentAntaraHukumNewsBinding
	...
	override fun onCreateView(
		...
		binding = FragmentAntaraHukumNewsBinding.inflate(inflater, container, false)
		return binding.root
	}
	...
	override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
		...
		commonViewModel.getAntaraHukumNews()
		commonViewModel.AntaraHukumNews.observe(viewLifecycleOwner) { newsResponse ->
